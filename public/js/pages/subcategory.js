...
commentEditor &&
    ...
    $(function () {
                    ...
                    columnDefs: [
                        ...
                        },
                        {
                            ...
                            render: function (t, e, s, n) {
                                return `<div class="d-flex justify-content-center align-items-center" style="height: 40px;"><img src="/storage/subcategory/${t}" alt="Avatar" class="rounded" style="max-width: 80%;"></div>`;
                            },
                        },
                        {
                            targets: 3,
        ...
        t.on("click", ".btn-edit", function () {
            ...
            $("#time_init").val(rowData.tinit);
            $("#time_finish").val(rowData.tfinish);
