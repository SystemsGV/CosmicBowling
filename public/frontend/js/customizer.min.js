(() => {
    const e = (e) => localStorage.getItem(e),
        ...
        a = `\n    :root {\n      ${
            ...
            e("theme-primary-rgb") &&
            `--${r}primary-rgb: ${e("theme-primary-rgb")};`
        }\n      ${
            e("theme-warning") && `--${r}warning-rgb: ${e("theme-warning")};`
        }\n      ${
            e("theme-warning-rgb") &&
            `--${r}warning-rgb: ${e("theme-warning-rgb")};`
        }\n      ${
            ...
            e("theme-success-rgb") &&
            `--${r}success-rgb: ${e("success-info-rgb")};`
        }\n      ${
            e("theme-danger") && `--${r}danger-rgb: ${e("danger-info")};`
        }\n      ${
            e("theme-danger-rgb") &&
            `--${r}danger-rgb: ${e("danger-info-rgb")};`
        }\n      ${
            e("theme-font-family") &&
            `--${r}body-font-family: ${e("theme-font-family")};`
        }\n      ${
            e("theme-root-font-size") &&
            `--${r}root-font-size: ${e("theme-root-font-size")};`
        }\n      ${
            e("theme-body-font-size") &&
            `--${r}body-font-size: ${e("theme-body-font-size")};`
        }\n      ${
            e("theme-border-width") &&
            `--${r}border-width: ${e("theme-border-width")};`
        }\n      ${
            e("theme-border-radius") &&
            `--${r}border-radius: ${e("theme-border-radius")};`
        }\n      ${
            e("theme-border-radius-sm") &&
            `--${r}border-radius-sm: ${e("theme-border-radius-sm")};`
        }\n      ${
            e("theme-border-radius-lg") &&
            `--${r}border-radius-lg: ${e("theme-border-radius-lg")};`
        }\n      ${
            e("theme-border-radius-xl") &&
            `--${r}border-radius-xl: ${e("theme-border-radius-xl")};`
        }\n      ${
            e("theme-border-radius-xxl") &&
            `--${r}border-radius-xxl: ${e("theme-border-radius-xxl")};`
        }\n      ${
            e("theme-primary") && `--${r}link-color: ${e("theme-primary")};`
        }\n      ${
            e("theme-primary-btn-hover-active-border-bg-color") &&
            `--${r}link-hover-color: ${e(
            ...
            e("theme-primary") &&
            `--${r}btn-border-color: ${e("theme-primary")};`
        }\n      ${
            e("theme-primary-btn-hover-active-border-bg-color") &&
            `--${r}btn-hover-bg: ${e(
                "theme-primary-btn-hover-active-border-bg-color"
            ...
            e("theme-primary-btn-hover-active-border-bg-color") &&
            `--${r}btn-active-border-color: ${e(
                "theme-primary-btn-hover-active-border-bg-color"
            )};`
        }\n      ${
            e("theme-primary") &&
            `--${r}btn-disabled-bg: ${e("theme-primary")};`
        }\n      ${
            e("theme-primary") &&
            `--${r}btn-disabled-border-color: ${e("theme-primary")};`
        }\n    }\n    .btn-warning {\n      ${
            e("theme-warning") && `--${r}btn-bg: ${e("theme-warning")};`
        }\n      ${
            e("theme-warning") &&
            `--${r}btn-border-color: ${e("theme-warning")};`
        }\n      ${
            ...
            e("theme-warning") &&
            `--${r}btn-disabled-bg: ${e("theme-warning")};`
        }\n      ${
            e("theme-warning") &&
            `--${r}btn-disabled-border-color: ${e("theme-warning")};`
        }\n    }\n    .btn-info {\n      ${
            ...
            e("theme-info") &&
            `--${r}btn-disabled-border-color: ${e("theme-info")};`
        }\n    }\n    .btn-success {\n      ${
            e("theme-success") && `--${r}btn-bg: ${e("theme-success")};`
        }\n      ${
            e("theme-success") &&
            `--${r}btn-border-color: ${e("theme-success")};`
        }\n      ${
            ...
            e("theme-success") &&
            `--${r}btn-disabled-bg: ${e("theme-success")};`
        }\n      ${
            e("theme-success") &&
            `--${r}btn-disabled-border-color: ${e("theme-success")};`
        }\n    }\n    .btn-danger {\n      ${
            ...
            e("theme-danger") &&
            `--${r}btn-disabled-border-color: ${e("theme-danger")};`
        }\n    }\n    .btn-outline-primary {\n      ${
            ...
            e("theme-primary") &&
            `--${r}btn-hover-border-color: ${e("theme-primary")};`
        }\n      ${
            e("theme-primary") && `--${r}btn-active-bg: ${e("theme-primary")};`
        }\n      ${
            e("theme-primary") &&
            `--${r}btn-active-border-color: ${e("theme-primary")};`
        }\n      ${
            e("theme-primary") &&
            `--${r}btn-disabled-color: ${e("theme-primary")};`
        }\n      ${
            e("theme-primary") &&
            `--${r}btn-disabled-border-color: ${e("theme-primary")};`
        }\n    }\n    .btn-outline-warning {\n      ${
            ...
            e("theme-warning") &&
            `--${r}btn-hover-border-color: ${e("theme-warning")};`
        }\n      ${
            e("theme-warning") && `--${r}btn-active-bg: ${e("theme-warning")};`
        }\n      ${
            e("theme-warning") &&
            `--${r}btn-active-border-color: ${e("theme-warning")};`
        }\n      ${
            e("theme-warning") &&
            `--${r}btn-disabled-color: ${e("theme-warning")};`
        }\n      ${
            e("theme-warning") &&
            `--${r}btn-disabled-border-color: ${e("theme-warning")};`
        }\n    }\n    .btn-outline-info {\n      ${
            ...
            e("theme-info") &&
            `--${r}btn-hover-border-color: ${e("theme-info")};`
        }\n      ${
            e("theme-info") && `--${r}btn-active-bg: ${e("theme-info")};`
        }\n      ${
            e("theme-info") &&
            `--${r}btn-active-border-color: ${e("theme-info")};`
        }\n      ${
            ...
            e("theme-success") &&
            `--${r}btn-hover-border-color: ${e("theme-success")};`
        }\n      ${
            e("theme-success") && `--${r}btn-active-bg: ${e("theme-success")};`
        }\n      ${
            e("theme-success") &&
            `--${r}btn-active-border-color: ${e("theme-success")};`
        }\n      ${
            e("theme-success") &&
            `--${r}btn-disabled-color: ${e("theme-success")};`
        }\n      ${
            e("theme-success") &&
            `--${r}btn-disabled-border-color: ${e("theme-success")};`
        }\n    }\n    .btn-outline-danger {\n      ${
            ...
            e("theme-danger") &&
            `--${r}btn-hover-border-color: ${e("theme-danger")};`
        }\n      ${
            e("theme-danger") && `--${r}btn-active-bg: ${e("theme-danger")};`
        }\n      ${
            e("theme-danger") &&
            `--${r}btn-active-border-color: ${e("theme-danger")};`
        }\n      ${
            e("theme-danger") &&
            `--${r}btn-disabled-color: ${e("theme-danger")};`
        }\n      ${
            e("theme-danger") &&
            `--${r}btn-disabled-border-color: ${e("theme-danger")};`
        }\n    }\n    .accordion-button:not(.collapsed)::after {\n      ${
            e("theme-accordion-btn-active-icon") &&
            `--${r}accordion-btn-active-icon: ${e(
    ...
    const c = {
        ...
        s = () => {
            (o.innerHTML = c.root.cssText.replace(/null|\s*(?![A-Z])/g, "")),
                (o.innerHTML +=
                    -1 === c.primaryBtn.cssText.indexOf("{ }")
                        ? c.primaryBtn.cssText.replace(/ /g, "")
                        : ""),
                (o.innerHTML +=
                    -1 === c.warningBtn.cssText.indexOf("{ }")
                        ? c.warningBtn.cssText.replace(/ /g, "")
                        : ""),
                (o.innerHTML +=
                    -1 === c.infoBtn.cssText.indexOf("{ }")
                        ? c.infoBtn.cssText.replace(/ /g, "")
                        : ""),
                (o.innerHTML +=
                    -1 === c.successBtn.cssText.indexOf("{ }")
                        ? c.successBtn.cssText.replace(/ /g, "")
                        : ""),
                (o.innerHTML +=
                    -1 === c.dangerBtn.cssText.indexOf("{ }")
                        ? c.dangerBtn.cssText.replace(/ /g, "")
                        : ""),
                (o.innerHTML +=
                    -1 === c.primaryOutlineBtn.cssText.indexOf("{ }")
                        ? c.primaryOutlineBtn.cssText.replace(/ /g, "")
                        : ""),
                (o.innerHTML +=
                    -1 === c.warningOutlineBtn.cssText.indexOf("{ }")
                        ? c.warningOutlineBtn.cssText.replace(/ /g, "")
                        : ""),
                (o.innerHTML +=
                    -1 === c.infoOutlineBtn.cssText.indexOf("{ }")
                        ? c.infoOutlineBtn.cssText.replace(/ /g, "")
                        : ""),
                (o.innerHTML +=
                    -1 === c.successOutlineBtn.cssText.indexOf("{ }")
                        ? c.successOutlineBtn.cssText.replace(/ /g, "")
                        : ""),
                (o.innerHTML +=
                    -1 === c.dangerOutlineBtn.cssText.indexOf("{ }")
                        ? c.dangerOutlineBtn.cssText.replace(/ /g, "")
                        : ""),
                (o.innerHTML +=
                    -1 === c.accordion.cssText.indexOf("{ }")
                        ? c.accordion.cssText.replace(/ /g, "")
                        : "");
        },
        b = (e) => {
            var t = 0,
        ...
        (i.value = e(d[n].id) || i.value),
            ...
            a.addEventListener("input", (e) => {
                ...
                t("theme-" + e.target.id, a),
                    ...
                    c.root.style.setProperty(
                        "--" + r + e.target.id + "-rgb",
                        b(a)
                    ),
                    c[e.target.id + "Btn"].style.setProperty("--ar-btn-bg", a),
                    c[e.target.id + "Btn"].style.setProperty(
                        "--ar-btn-border-color",
                        a
                    ),
                    c[e.target.id + "Btn"].style.setProperty(
                    ...
                    c[e.target.id + "OutlineBtn"].style.setProperty(
                        "--ar-btn-color",
                        a
                    ),
                    c[e.target.id + "OutlineBtn"].style.setProperty(
            ...
            i.addEventListener("change", (e) => {
                ...
                0 != a.length &&
                    ...
                    t(
                        "theme-" + o.id + "-btn-hover-active-border-bg-color",
                        l(a, -10)
                    ),
                    (n.style.backgroundColor = a),
                    (o.value = a),
                    ...
                    c[o.id + "OutlineBtn"].style.setProperty(
                        "--ar-btn-color",
                        a
                    ),
                    c[o.id + "OutlineBtn"].style.setProperty(
    ...
    (g.value = e("theme-font-family") || g.value),
        g.addEventListener("blur", (e) => {
            ...
            t("theme-font-family", r),
                c.root.style.setProperty("--ar-body-font-family", r),
                s();
        });
    ...
    ($.value = e("theme-root-font-size") || $.value),
        $.addEventListener("change", (e) => {
            const r = e.target.value;
            t("theme-root-font-size", r),
                c.root.style.setProperty("--ar-root-font-size", r),
                s();
        });
    ...
    (v.value = e("theme-body-font-size") || v.value),
        v.addEventListener("change", (e) => {
            const r = e.target.value;
            t("theme-body-font-size", r),
                c.root.style.setProperty("--ar-body-font-size", r),
                s();
        });
    ...
    (u.value = parseInt(e("theme-border-width")) || u.value),
        u.addEventListener("input", (e) => {
            ...
            t("theme-border-width", r + "px"),
                c.root.style.setProperty("--ar-border-width", r + "px"),
                s();
        });
    ...
    (y.value = parseFloat(e("theme-border-radius")) || y.value),
        y.addEventListener("input", (e) => {
            ...
            t("theme-border-radius", r + "rem"),
                c.root.style.setProperty("--ar-border-radius", r + "rem"),
                s();
        });
    ...
    for (let n = 0; n < p.length; n++)
        (p[n].value = e("theme-" + p[n].id + "multiplier") || p[n].value),
            p[n].addEventListener("input", (e) => {
                ...
                t(
                    "theme-" + e.target.id,
                    "calc(var(--ar-border-radius) * " + n + ")"
                ),
                    t("theme-" + e.target.id + "multiplier", n),
                    c.root.style.setProperty(
                        "--" + r + e.target.id,
                        "calc(var(--ar-border-radius) * " + n + ")"
                    ),
    ...
    document
        ...
        .addEventListener("click", () => {
            ...
            for (let t = 0; t < localStorage.length; t++)
                "theme" == localStorage.key(t).substring(0, 5) &&
