...
!(function () {
    ...
    !(function (e, t) {
                ...
                if (
                    (this._config.parent &&
                        (e = this._getFirstLevelChildren(
                            ...
                            .map((e) =>
                                ze.getOrCreateInstance(e, { toggle: !1 })
                            )),
        ...
        function It(e) {
            ...
            return n &&
                ("html" === ht(n) ||
                    ("body" === ht(n) && "static" === Ot(n).position))
                ? t
                : n ||
                      (function (e) {
                      ...
                      (function (e) {
                          ...
                          return (
                              "rtl" === Ot(s || n).direction &&
                                  (a +=
                                      vt(n.clientWidth, s ? s.clientWidth : 0) -
                                      o),
                ...
                for (let t = 0; t < e.length; t++) {
                    ...
                    if (n && "" !== n) {
                        const s = JSON.parse(n),
                            ...
                            c = s.markers;
                        if (
                            ((i = L.map(e[t], { scrollWheelZoom: l }).setView(
                                r,
                                a
                            )),
                            L.tileLayer(o, {
            ...
            if (0 !== e.length)
                for (let t = 0; t < e.length; t++) {
                    ...
                    const s = {
                        ...
                        defaultDate: tomorrow.toISOString().split("T")[0], // Establecer el día siguiente como la fecha predeterminada
                        maxDate: maxDateISO, // Establecer la fecha dentro de 8 días como la fecha máxima
                    };
                    flatpickr(e[t], s);
                }
        })(),
        ((e, t, n) => {
            ...
            let options = {
                ...
                visibleRange: function (currentDate) {
                    var start = currentDate.clone().startOf("week");
            ...
            new FullCalendar.Calendar(t, options).render();
        }),
        (() => {
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const logoutButton2 = document.getElementById("logoutbtn");
        
            // Verifica si existe el primer botón y añade el listener
            if (logoutButton) {
            ...
            // Verifica si existe el segundo botón y añade el listener
            if (logoutButton2) {
                logoutButton2.addEventListener("click", async function () {
                    await handleLogout();
                });
            }
            ...
            async function handleLogout() {
                ...
                try {
                    ...
                    if (response.ok) {
                        ...
                        // Redirige a la página de inicio u otra acción después del logout
                        window.location.href = "/"; // Redirige al inicio, por ejemplo
                    } else {
        ...
        /*(() => {
            ...
            for (let t = 0; t < e.length; t++) {
                const n = e[t],
                    ...
                    r = () => {
                        o.value++;
                        inputGuests.dispatchEvent(new Event("change"));
                    },
                    a = () => {
                        o.value > 0 && o.value--;
                        inputGuests.dispatchEvent(new Event("change"));
                ...
                e[i]
                    ...
                    .addEventListener("change", (e) => {
                        const i = e.currentTarget.querySelector(
                            ...
                            s = e.currentTarget.querySelector(
                                "[data-annual-switch]"
                            ),
                            o = e.currentTarget
