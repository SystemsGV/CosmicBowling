                    ...
                    <table border="0" bgcolor="#121212" cellpadding="0" cellspacing="0" width="640"
                        ...
                        <tbody>
                            <tr width="640" style="width: 640px; min-width: 640px; " align="center">
                                        ...
                                        <tr width="640" style="width: 640px; min-width: 640px; " align="center">
                                            <td>
                                                ...
                                                <table cellpadding="0" cellspacing="0" border="0" width="640"
                                                    ...
                                                    align="center" bgcolor="#b12b77">
                                                    <tr>
                                                        <td align="left">
                                                            <table cellpadding="0" cellspacing="0" border="0"
                                                                role="presentation" align="center" bgcolor="#b12b77">
                                                                <tr>
                                                                    <td>
                                ...
                                <table cellpadding="0" cellspacing="0" border="0" align="center" width="640"
                                    style="width: 640px; min-width: 640px;" role="presentation" bgcolor="#b12b77">
                                    <tr>
                                        <td height="60" style="line-height:60px;min-height:60px;">
                                        </td>
                                    </tr>
                                ...
                                <table bgcolor="#f1f1f1" cellpadding="0" cellspacing="0" border="0"
                                    ...
                                    style="width: 640px; min-width: 640px;-webkit-text-fill-color: #f1f1f1;"
                                    role="presentation" class="table-container ">
                                    <tr>
                                        <td height="35" style="line-height:35px;min-height:35px;">
                                        </td>
                                ...
                                <table bgcolor="#f1f1f1" cellpadding="0" cellspacing="0" border="0"
                                    ...
                                    <tr>
                                        <td
                                            style="color:#444444; font-size:14px; line-height:22px; text-align:center;border:none;font-weight:bold;">
                                            Calle Mantaro 300 San Miguel. Lima, Peru <br>
                                            © 2024 Cosmic Bowling. <br>
                                        </td>
                                    </tr>
                                </table>
                                <table bgcolor="#f1f1f1" cellpadding="0" cellspacing="0" border="0"
