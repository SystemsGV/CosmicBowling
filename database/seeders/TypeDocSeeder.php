...
class TypeDocSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('sunat_typedoc')->insert([
            ['id_doc' => '00', 'name_doc' => 'OTRO DOCUMENTO (COD 0)', 'description_doc' => 'DOC.TRIB.NO.DOM.SIN.RUC'],
            ['id_doc' => '01', 'name_doc' => 'D.N.I.', 'description_doc' => 'DOC. NACIONAL DE IDENTIDAD'],
            ['id_doc' => '04', 'name_doc' => 'CARNET DE EXTRANJERIA (COD 4)', 'description_doc' => 'CARNET DE EXTRANJERIA'],
            ['id_doc' => '06', 'name_doc' => 'R.U.C.', 'description_doc' => 'REG. UNICO DE CONTRIBUYENTES'],
            ['id_doc' => '07', 'name_doc' => 'PASAPORTE (COD 7)', 'description_doc' => 'PASAPORTE'],
